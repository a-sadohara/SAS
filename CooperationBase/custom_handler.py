...
class ParallelTimedRotatingFileHandler(logging.handlers.TimedRotatingFileHandler):
    ...
    def calculateFileName(self, currenttime):
        ...
        return self.origFileName + "_" + time.strftime(self.suffix, timeTuple) + self.postfix
...
logging.handlers.CustomTimedRotatingFileHandler = ParallelTimedRotatingFileHandler